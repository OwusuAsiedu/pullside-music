    ...
    <nav className="bg-black text-white p-4">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <ul className="flex space-x-4">
          ...
          <li><Link to="/new-releases" className="hover:text-gray-300 transition duration-300">New Releases</Link></li>
          <li><Link to="/trending" className="hover:text-gray-300 transition duration-300">Trending</Link></li>
          <li><Link to="/news" className="hover:text-gray-300 transition duration-300">News</Link></li>
